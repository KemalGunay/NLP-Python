...
# Wordcloud
###############################
# burada 4 ve 5 puan verenlerin bir kelime bulutu olusturulabilir
# 1, 2, 3 puan verenlerin kelime bulutu oluşturup, ikisi karşılaştırılabilir
...
# CBOW (Continuous Bag-of-Words): Contex'ten tek bir kelimeyi tahmin etmek.
# Skip-gram: Tek bir kelimeden contex'i tahmin etmek

# Life is like riding a biycle. To keep your balance, you must keep moving. Albert Einstein.

# CBOW: Input = [is, like, a, bicycle], Output = riding

# Skip-gram = riding, Output = [is, like, a, bicycle]
